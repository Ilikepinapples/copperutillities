...
public class CopperAnvilScreenHandler extends ForgingScreenHandler {
        ...
        public CopperAnvilScreenHandler(int syncId, PlayerInventory inventory) {
            this(syncId, inventory, ScreenHandlerContext.EMPTY);
        }

        public CopperAnvilScreenHandler(int syncId, PlayerInventory inventory, ScreenHandlerContext context) {
